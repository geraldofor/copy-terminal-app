...
const pt = {
  ...
  "landing.ctaButton": "criar conta e gerar minha primeira copy",
  "landing.hasAccount": "já tem conta?",
  "landing.ctaSignin": "entrar →",
  "landing.trust1": "// sem setup técnico",
...
const en: UiStrings = {
  ...
  "landing.ctaButton": "create account and generate my first copy",
  "landing.hasAccount": "already have an account?",
  "landing.ctaSignin": "sign in →",
  "landing.trust1": "// no setup required",
