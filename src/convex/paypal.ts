 ...
 * server. The Plans page prefers the Vite build-time value
 * (import.meta.env.VITE_PAYPAL_CLIENT_ID) and falls back to this query so
 * checkout works even when the frontend was built before the keys were
 * added. Both variables are read from the project's Keys / API keys UI.
 *
